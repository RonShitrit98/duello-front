    ...
    <section class="create-board">
      ...
      <div class="main-content">
        ...
        <div class="img-container">
          <div
            class="img-boxes"
            v-for="img in design.imgs.slice(0, 4)"
            :key="img.id"
  ...
  computed: {
    getPrevStyle() {
      ...
      if (this.boardToEdit.style.type === "color") {
        ...
        return `background-image: url(${this.boardToEdit.style.backgroundImg.thumb});`;
    },
    isTitle() {
