<template>
  <section class="task-details-menu">
    <div class="task-menu">
      <div v-if="!isMember&&isAllowed" class="task-menu-group">
        <h2>Suggested</h2>
        <button @click="joinTask">
          <icon-base class="icon-fill" iconName="member" />Join
        </button>
      </div>
      ...
      <div class="task-menu-group">
        ...
        <button @click="openModal('member-cmp')">
          <icon-base class="icon-color" iconName="member" />Members
        </button>
        <button @click="openModal('label-cmp')">
          <icon-base class="icon-color" iconName="label" />Labels
        </button>
      ...
      <div class="task-menu-group">
        <h2>Actions</h2>
        <button @click="openModal('copy-cmp')">
